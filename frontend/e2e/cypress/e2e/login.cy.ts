...
describe('Login Page UI Checks', () => {
  ...
  it('Should have email label and input field', () => {
    ...
    cy.xpath('//input[@id="uname" and @formcontrolname="userName"]')
      .should('exist')
      .and('be.visible');
  });
  ...
  it('Should have password label and input field', () => {
    ...
    cy.xpath('//input[@id="pass" and @formcontrolname="password"]')
      .should('exist')
      .and('be.visible');
  });

  it('Should have Forgot Password link', () => {
    cy.get('a.forget-password-btn')
      .should('be.visible')
      .and('have.attr', 'href')
...
describe('Forgot Password Navigation', () => {
  it('Should navigate to the forgot password page', () => {
    cy.visit('/#/login');
    cy.xpath(
      '/html/body/app-root/app-root/app-login/div/div/div[2]/div/div/div/div/div/div[2]/form/div[3]/a'
    ).click();
...
describe('Login Page Form Check', () => {
  it('Should contain the login form', () => {
    cy.visit('/#/login');
    cy.xpath(
      '/html/body/app-root/app-root/app-login/div/div/div[2]/div/div/div/div/div/div[2]/form'
    ).should('exist');
  });
});
