...
describe('Document Categories Page UI Test', () => {
  ...
  it('Should show Document Categories title in header', () => {
    cy.xpath("//span[contains(text(),'Document Categories')]")
      .should('exist')
      .and('be.visible');
  });

  it('Should display Add Document Category button', () => {
    cy.xpath("//a//span[contains(text(),'Add Document Category')]")
      .should('exist')
      .and('be.visible');
  });
  ...
  it('Should display chevron icon for expanding child categories', () => {
    cy.xpath("//i-feather//*[name()='svg' and contains(@class,'feather-chevrons-right')]")
      .should('exist');
  });
...
describe('Document Category CRUD Test', () => {
  ...
  it('Should add a new document category', () => {
    cy.xpath("//span[contains(text(),'Add Document Category')]/parent::a")
      .click({ force: true });
  ...
  it('Should edit the added category', () => {
    ...
    cy.contains('td', dummyCategory, { timeout: 10000 })
      .should('be.visible')
      .parent('tr')
      .within(() => {
